...
// MantasSpacingRule lints given else constructs.
type MantasSpacingRule struct{}

// Apply applies the rule to given file.
func (r *MantasSpacingRule) Apply(file *lint.File, _ lint.Arguments) []lint.Failure {
...
func (r *MantasSpacingRule) Name() string {
	return "mantas-spacing"
}
